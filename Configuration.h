...
#define DELTA
  ...
  #define DELTA_HEIGHT 317// get this value from auto calibrate

 // #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 100 //mm  Get this value from auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT,80 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define MANUAL_Z_HOME_POS 317 //DELTA_HEIGHT  Distance between the nozzle to printbed after homing
...
#define HOMING_FEEDRATE_Z  (200*60, 200*60,200*60, 0)
